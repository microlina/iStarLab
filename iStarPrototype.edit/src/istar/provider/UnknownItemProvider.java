...
/**
 * This is the item provider adapter for a {@link istar.Unknown} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnknownItemProvider extends ContributionLinkItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Unknown)object).getRelationshipName();
		return label == null || label.length() == 0 ?
			getString("_UI_Unknown_type") :
			getString("_UI_Unknown_type") + " " + label;
	}
