 ...
 * <ul>
 *   <li>{@link istart.impl.NodeImpl#getNodeName <em>Node Name</em>}</li>
 *   <li>{@link istart.impl.NodeImpl#getNodeDependency <em>Node Dependency</em>}</li>
 *   <li>{@link istart.impl.NodeImpl#getSecondNodeDependency <em>Second Node Dependency</em>}</li>
 *   <li>{@link istart.impl.NodeImpl#getNodeNFR <em>Node NFR</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeImpl extends EObjectImpl implements Node
{
  ...
  {
    return IstartPackage.Literals.NODE;
  }
  ...
  public void setNodeName(String newNodeName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.NODE__NODE_NAME, oldNodeName, nodeName));
  }
  ...
  public EList<DependencyLink> getNodeDependency()
  {
    ...
    {
      nodeDependency = new EObjectWithInverseResolvingEList<DependencyLink>(DependencyLink.class, this, IstartPackage.NODE__NODE_DEPENDENCY, IstartPackage.DEPENDENCY_LINK__DEPENDENCY_NODE);
    }
  ...
  public EList<DependencyLink> getSecondNodeDependency()
  {
    ...
    {
      secondNodeDependency = new EObjectWithInverseResolvingEList<DependencyLink>(DependencyLink.class, this, IstartPackage.NODE__SECOND_NODE_DEPENDENCY, IstartPackage.DEPENDENCY_LINK__DEPENDENCY_SECOND_NODE);
    }
  ...
  public EList<NFR> getNodeNFR()
  {
    if (nodeNFR == null)
    {
      nodeNFR = new EDataTypeUniqueEList<NFR>(NFR.class, this, IstartPackage.NODE__NODE_NFR);
    }
    return nodeNFR;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case IstartPackage.NODE__NODE_NAME:
        return getNodeName();
      case IstartPackage.NODE__NODE_DEPENDENCY:
        return getNodeDependency();
      case IstartPackage.NODE__SECOND_NODE_DEPENDENCY:
        return getSecondNodeDependency();
      case IstartPackage.NODE__NODE_NFR:
        return getNodeNFR();
    }
