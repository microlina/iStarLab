 ...
 * <ul>
 *   <li>{@link istart.impl.RelationshipImpl#getRelationshipName <em>Relationship Name</em>}</li>
 *   <li>{@link istart.impl.RelationshipImpl#getSource <em>Source</em>}</li>
 *   <li>{@link istart.impl.RelationshipImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link istart.impl.RelationshipImpl#getRelationshipNFR <em>Relationship NFR</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationshipImpl extends EObjectImpl implements Relationship
{
  ...
  {
    return IstartPackage.Literals.RELATIONSHIP;
  }
  ...
  public void setRelationshipName(String newRelationshipName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.RELATIONSHIP__RELATIONSHIP_NAME, oldRelationshipName, relationshipName));
  }
  ...
  public void setSource(String newSource)
  {
    ...
    source = newSource;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.RELATIONSHIP__SOURCE, oldSource, source));
  }
  ...
  public void setTarget(String newTarget)
  {
    ...
    target = newTarget;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.RELATIONSHIP__TARGET, oldTarget, target));
  }
  ...
  public EList<NFR> getRelationshipNFR()
  {
    ...
    {
      relationshipNFR = new EDataTypeUniqueEList<NFR>(NFR.class, this, IstartPackage.RELATIONSHIP__RELATIONSHIP_NFR);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case IstartPackage.RELATIONSHIP__RELATIONSHIP_NAME:
        return getRelationshipName();
      case IstartPackage.RELATIONSHIP__SOURCE:
        return getSource();
      case IstartPackage.RELATIONSHIP__TARGET:
        return getTarget();
      case IstartPackage.RELATIONSHIP__RELATIONSHIP_NFR:
