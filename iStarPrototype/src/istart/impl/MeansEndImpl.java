 ...
 * <ul>
 *   <li>{@link istart.impl.MeansEndImpl#getMeansEndTask <em>Means End Task</em>}</li>
 *   <li>{@link istart.impl.MeansEndImpl#getMeansEndGoal <em>Means End Goal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MeansEndImpl extends DecompositionImpl implements MeansEnd
{
  ...
  {
    return IstartPackage.Literals.MEANS_END;
  }
    ...
    if (meansEndTask != null && meansEndTask.eIsProxy())
    {
      ...
      if (meansEndTask != oldMeansEndTask)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstartPackage.MEANS_END__MEANS_END_TASK, oldMeansEndTask, meansEndTask));
      }
    }
    return meansEndTask;
  }
  ...
  public NotificationChain basicSetMeansEndTask(Task newMeansEndTask, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstartPackage.MEANS_END__MEANS_END_TASK, oldMeansEndTask, newMeansEndTask);
  ...
  public void setMeansEndTask(Task newMeansEndTask)
  {
    if (newMeansEndTask != meansEndTask)
    {
      ...
      if (meansEndTask != null)
        msgs = ((InternalEObject)meansEndTask).eInverseRemove(this, IstartPackage.TASK__TASK_MEANS_END, Task.class, msgs);
      if (newMeansEndTask != null)
        msgs = ((InternalEObject)newMeansEndTask).eInverseAdd(this, IstartPackage.TASK__TASK_MEANS_END, Task.class, msgs);
      msgs = basicSetMeansEndTask(newMeansEndTask, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.MEANS_END__MEANS_END_TASK, newMeansEndTask, newMeansEndTask));
  }
  ...
  public Goal getMeansEndGoal()
  {
    if (meansEndGoal != null && meansEndGoal.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstartPackage.MEANS_END__MEANS_END_GOAL, oldMeansEndGoal, meansEndGoal));
      }
    }
    return meansEndGoal;
  }
  ...
  public NotificationChain basicSetMeansEndGoal(Goal newMeansEndGoal, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstartPackage.MEANS_END__MEANS_END_GOAL, oldMeansEndGoal, newMeansEndGoal);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMeansEndGoal(Goal newMeansEndGoal)
  {
    if (newMeansEndGoal != meansEndGoal)
    {
      ...
      if (meansEndGoal != null)
        msgs = ((InternalEObject)meansEndGoal).eInverseRemove(this, IstartPackage.GOAL__GOAL_MEANS_END, Goal.class, msgs);
      if (newMeansEndGoal != null)
        msgs = ((InternalEObject)newMeansEndGoal).eInverseAdd(this, IstartPackage.GOAL__GOAL_MEANS_END, Goal.class, msgs);
      msgs = basicSetMeansEndGoal(newMeansEndGoal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.MEANS_END__MEANS_END_GOAL, newMeansEndGoal, newMeansEndGoal));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IstartPackage.MEANS_END__MEANS_END_TASK:
        if (meansEndTask != null)
          msgs = ((InternalEObject)meansEndTask).eInverseRemove(this, IstartPackage.TASK__TASK_MEANS_END, Task.class, msgs);
        return basicSetMeansEndTask((Task)otherEnd, msgs);
      case IstartPackage.MEANS_END__MEANS_END_GOAL:
        if (meansEndGoal != null)
          msgs = ((InternalEObject)meansEndGoal).eInverseRemove(this, IstartPackage.GOAL__GOAL_MEANS_END, Goal.class, msgs);
