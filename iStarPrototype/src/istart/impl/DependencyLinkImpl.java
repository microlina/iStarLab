 ...
 * <ul>
 *   <li>{@link istart.impl.DependencyLinkImpl#getStrength <em>Strength</em>}</li>
 *   <li>{@link istart.impl.DependencyLinkImpl#getDependencyName <em>Dependency Name</em>}</li>
 *   <li>{@link istart.impl.DependencyLinkImpl#getDependencyNode <em>Dependency Node</em>}</li>
 *   <li>{@link istart.impl.DependencyLinkImpl#getDependencySecondNode <em>Dependency Second Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependencyLinkImpl extends RelationshipImpl implements DependencyLink
{
  ...
  {
    return IstartPackage.Literals.DEPENDENCY_LINK;
  }
  ...
  public void setStrength(DependencyStrength newStrength)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.DEPENDENCY_LINK__STRENGTH, oldStrength, strength));
  }
  ...
  public void setDependencyName(String newDependencyName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.DEPENDENCY_LINK__DEPENDENCY_NAME, oldDependencyName, dependencyName, !oldDependencyNameESet));
  }
  ...
  public void unsetDependencyName()
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, IstartPackage.DEPENDENCY_LINK__DEPENDENCY_NAME, oldDependencyName, DEPENDENCY_NAME_EDEFAULT, oldDependencyNameESet));
  }
  ...
  public Node getDependencyNode()
  {
    if (dependencyNode != null && dependencyNode.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstartPackage.DEPENDENCY_LINK__DEPENDENCY_NODE, oldDependencyNode, dependencyNode));
      }
    }
  ...
  public NotificationChain basicSetDependencyNode(Node newDependencyNode, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstartPackage.DEPENDENCY_LINK__DEPENDENCY_NODE, oldDependencyNode, newDependencyNode);
  ...
  public void setDependencyNode(Node newDependencyNode)
  {
    if (newDependencyNode != dependencyNode)
    {
      ...
      if (dependencyNode != null)
        msgs = ((InternalEObject)dependencyNode).eInverseRemove(this, IstartPackage.NODE__NODE_DEPENDENCY, Node.class, msgs);
      if (newDependencyNode != null)
        msgs = ((InternalEObject)newDependencyNode).eInverseAdd(this, IstartPackage.NODE__NODE_DEPENDENCY, Node.class, msgs);
      msgs = basicSetDependencyNode(newDependencyNode, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.DEPENDENCY_LINK__DEPENDENCY_NODE, newDependencyNode, newDependencyNode));
  }
  ...
  public Node getDependencySecondNode()
  {
    if (dependencySecondNode != null && dependencySecondNode.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstartPackage.DEPENDENCY_LINK__DEPENDENCY_SECOND_NODE, oldDependencySecondNode, dependencySecondNode));
      }
    }
  ...
  public NotificationChain basicSetDependencySecondNode(Node newDependencySecondNode, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstartPackage.DEPENDENCY_LINK__DEPENDENCY_SECOND_NODE, oldDependencySecondNode, newDependencySecondNode);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDependencySecondNode(Node newDependencySecondNode)
  {
    if (newDependencySecondNode != dependencySecondNode)
    {
      ...
      if (dependencySecondNode != null)
        msgs = ((InternalEObject)dependencySecondNode).eInverseRemove(this, IstartPackage.NODE__SECOND_NODE_DEPENDENCY, Node.class, msgs);
      if (newDependencySecondNode != null)
        msgs = ((InternalEObject)newDependencySecondNode).eInverseAdd(this, IstartPackage.NODE__SECOND_NODE_DEPENDENCY, Node.class, msgs);
      msgs = basicSetDependencySecondNode(newDependencySecondNode, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.DEPENDENCY_LINK__DEPENDENCY_SECOND_NODE, newDependencySecondNode, newDependencySecondNode));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IstartPackage.DEPENDENCY_LINK__DEPENDENCY_NODE:
        if (dependencyNode != null)
          msgs = ((InternalEObject)dependencyNode).eInverseRemove(this, IstartPackage.NODE__NODE_DEPENDENCY, Node.class, msgs);
        return basicSetDependencyNode((Node)otherEnd, msgs);
      case IstartPackage.DEPENDENCY_LINK__DEPENDENCY_SECOND_NODE:
        if (dependencySecondNode != null)
          msgs = ((InternalEObject)dependencySecondNode).eInverseRemove(this, IstartPackage.NODE__SECOND_NODE_DEPENDENCY, Node.class, msgs);
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case IstartPackage.DEPENDENCY_LINK__STRENGTH:
        return getStrength();
      case IstartPackage.DEPENDENCY_LINK__DEPENDENCY_NAME:
