 ...
 * <ul>
 *   <li>{@link istart.impl.DecompositionLinkImpl#getDecompositionTask <em>Decomposition Task</em>}</li>
 *   <li>{@link istart.impl.DecompositionLinkImpl#getDecompositionElement <em>Decomposition Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DecompositionLinkImpl extends DecompositionImpl implements DecompositionLink
{
  ...
  {
    return IstartPackage.Literals.DECOMPOSITION_LINK;
  }
    ...
    if (decompositionTask != null && decompositionTask.eIsProxy())
    {
      ...
      if (decompositionTask != oldDecompositionTask)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstartPackage.DECOMPOSITION_LINK__DECOMPOSITION_TASK, oldDecompositionTask, decompositionTask));
      }
    }
  ...
  public NotificationChain basicSetDecompositionTask(Task newDecompositionTask, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstartPackage.DECOMPOSITION_LINK__DECOMPOSITION_TASK, oldDecompositionTask, newDecompositionTask);
  ...
  public void setDecompositionTask(Task newDecompositionTask)
  {
    if (newDecompositionTask != decompositionTask)
    {
      ...
      if (decompositionTask != null)
        msgs = ((InternalEObject)decompositionTask).eInverseRemove(this, IstartPackage.TASK__TASK_DECOMPOSITION, Task.class, msgs);
      if (newDecompositionTask != null)
        msgs = ((InternalEObject)newDecompositionTask).eInverseAdd(this, IstartPackage.TASK__TASK_DECOMPOSITION, Task.class, msgs);
      msgs = basicSetDecompositionTask(newDecompositionTask, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.DECOMPOSITION_LINK__DECOMPOSITION_TASK, newDecompositionTask, newDecompositionTask));
  }
  ...
  public Element getDecompositionElement()
  {
    if (decompositionElement != null && decompositionElement.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstartPackage.DECOMPOSITION_LINK__DECOMPOSITION_ELEMENT, oldDecompositionElement, decompositionElement));
      }
    }
  ...
  public NotificationChain basicSetDecompositionElement(Element newDecompositionElement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstartPackage.DECOMPOSITION_LINK__DECOMPOSITION_ELEMENT, oldDecompositionElement, newDecompositionElement);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDecompositionElement(Element newDecompositionElement)
  {
    if (newDecompositionElement != decompositionElement)
    {
      ...
      if (decompositionElement != null)
        msgs = ((InternalEObject)decompositionElement).eInverseRemove(this, IstartPackage.ELEMENT__ELEMENT_DECOMPOSITION, Element.class, msgs);
      if (newDecompositionElement != null)
        msgs = ((InternalEObject)newDecompositionElement).eInverseAdd(this, IstartPackage.ELEMENT__ELEMENT_DECOMPOSITION, Element.class, msgs);
      msgs = basicSetDecompositionElement(newDecompositionElement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.DECOMPOSITION_LINK__DECOMPOSITION_ELEMENT, newDecompositionElement, newDecompositionElement));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IstartPackage.DECOMPOSITION_LINK__DECOMPOSITION_TASK:
        if (decompositionTask != null)
          msgs = ((InternalEObject)decompositionTask).eInverseRemove(this, IstartPackage.TASK__TASK_DECOMPOSITION, Task.class, msgs);
        return basicSetDecompositionTask((Task)otherEnd, msgs);
      case IstartPackage.DECOMPOSITION_LINK__DECOMPOSITION_ELEMENT:
        if (decompositionElement != null)
          msgs = ((InternalEObject)decompositionElement).eInverseRemove(this, IstartPackage.ELEMENT__ELEMENT_DECOMPOSITION, Element.class, msgs);
