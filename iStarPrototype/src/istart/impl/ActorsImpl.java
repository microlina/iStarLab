 ...
 * <ul>
 *   <li>{@link istart.impl.ActorsImpl#getHasElement <em>Has Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ActorsImpl extends NodeImpl implements Actors
{
  ...
  {
    return IstartPackage.Literals.ACTORS;
  }
  ...
  public EList<Element> getHasElement()
  {
    if (hasElement == null)
    {
      hasElement = new EObjectContainmentEList.Unsettable<Element>(Element.class, this, IstartPackage.ACTORS__HAS_ELEMENT);
    }
    return hasElement;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IstartPackage.ACTORS__HAS_ELEMENT:
