 ...
 * <ul>
 *   <li>{@link istart.impl.ContributionLinkImpl#getContributionElement <em>Contribution Element</em>}</li>
 *   <li>{@link istart.impl.ContributionLinkImpl#getContributionSoftgoal <em>Contribution Softgoal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ContributionLinkImpl extends RelationshipImpl implements ContributionLink
{
  ...
  {
    return IstartPackage.Literals.CONTRIBUTION_LINK;
  }
    ...
    if (contributionElement != null && contributionElement.eIsProxy())
    {
      ...
      if (contributionElement != oldContributionElement)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstartPackage.CONTRIBUTION_LINK__CONTRIBUTION_ELEMENT, oldContributionElement, contributionElement));
      }
    }
  ...
  public NotificationChain basicSetContributionElement(Element newContributionElement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstartPackage.CONTRIBUTION_LINK__CONTRIBUTION_ELEMENT, oldContributionElement, newContributionElement);
  ...
  public void setContributionElement(Element newContributionElement)
  {
    if (newContributionElement != contributionElement)
    {
      ...
      if (contributionElement != null)
        msgs = ((InternalEObject)contributionElement).eInverseRemove(this, IstartPackage.ELEMENT__ELEMENT_CONTRIBUTION, Element.class, msgs);
      if (newContributionElement != null)
        msgs = ((InternalEObject)newContributionElement).eInverseAdd(this, IstartPackage.ELEMENT__ELEMENT_CONTRIBUTION, Element.class, msgs);
      msgs = basicSetContributionElement(newContributionElement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.CONTRIBUTION_LINK__CONTRIBUTION_ELEMENT, newContributionElement, newContributionElement));
  }
  ...
  public Softgoal getContributionSoftgoal()
  {
    if (contributionSoftgoal != null && contributionSoftgoal.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstartPackage.CONTRIBUTION_LINK__CONTRIBUTION_SOFTGOAL, oldContributionSoftgoal, contributionSoftgoal));
      }
    }
  ...
  public NotificationChain basicSetContributionSoftgoal(Softgoal newContributionSoftgoal, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstartPackage.CONTRIBUTION_LINK__CONTRIBUTION_SOFTGOAL, oldContributionSoftgoal, newContributionSoftgoal);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setContributionSoftgoal(Softgoal newContributionSoftgoal)
  {
    if (newContributionSoftgoal != contributionSoftgoal)
    {
      ...
      if (contributionSoftgoal != null)
        msgs = ((InternalEObject)contributionSoftgoal).eInverseRemove(this, IstartPackage.SOFTGOAL__SOFTGOAL_CONTRIBUTION, Softgoal.class, msgs);
      if (newContributionSoftgoal != null)
        msgs = ((InternalEObject)newContributionSoftgoal).eInverseAdd(this, IstartPackage.SOFTGOAL__SOFTGOAL_CONTRIBUTION, Softgoal.class, msgs);
      msgs = basicSetContributionSoftgoal(newContributionSoftgoal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IstartPackage.CONTRIBUTION_LINK__CONTRIBUTION_SOFTGOAL, newContributionSoftgoal, newContributionSoftgoal));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IstartPackage.CONTRIBUTION_LINK__CONTRIBUTION_ELEMENT:
        if (contributionElement != null)
          msgs = ((InternalEObject)contributionElement).eInverseRemove(this, IstartPackage.ELEMENT__ELEMENT_CONTRIBUTION, Element.class, msgs);
        return basicSetContributionElement((Element)otherEnd, msgs);
      case IstartPackage.CONTRIBUTION_LINK__CONTRIBUTION_SOFTGOAL:
        if (contributionSoftgoal != null)
          msgs = ((InternalEObject)contributionSoftgoal).eInverseRemove(this, IstartPackage.SOFTGOAL__SOFTGOAL_CONTRIBUTION, Softgoal.class, msgs);
