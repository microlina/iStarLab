 ...
 * <ul>
 *   <li>{@link istar.impl.PlaysImpl#getPlaysRole <em>Plays Role</em>}</li>
 *   <li>{@link istar.impl.PlaysImpl#getPlaysAgent <em>Plays Agent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlaysImpl extends AssociationImpl implements Plays
{
  ...
  {
		return IstarPackage.Literals.PLAYS;
	}
		...
		if (playsRole != null && playsRole.eIsProxy()) {
			...
			if (playsRole != oldPlaysRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstarPackage.PLAYS__PLAYS_ROLE, oldPlaysRole, playsRole));
			}
		}
		return playsRole;
	}
  ...
  public NotificationChain basicSetPlaysRole(Role newPlaysRole, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstarPackage.PLAYS__PLAYS_ROLE, oldPlaysRole, newPlaysRole);
  ...
  public void setPlaysRole(Role newPlaysRole)
  {
		if (newPlaysRole != playsRole) {
			...
			if (playsRole != null)
				msgs = ((InternalEObject)playsRole).eInverseRemove(this, IstarPackage.ROLE__ROLE_PLAYS, Role.class, msgs);
			if (newPlaysRole != null)
				msgs = ((InternalEObject)newPlaysRole).eInverseAdd(this, IstarPackage.ROLE__ROLE_PLAYS, Role.class, msgs);
			msgs = basicSetPlaysRole(newPlaysRole, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IstarPackage.PLAYS__PLAYS_ROLE, newPlaysRole, newPlaysRole));
	}
  ...
  public Agent getPlaysAgent()
  {
		if (playsAgent != null && playsAgent.eIsProxy()) {
			...
			if (playsAgent != oldPlaysAgent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstarPackage.PLAYS__PLAYS_AGENT, oldPlaysAgent, playsAgent));
			}
		}
		return playsAgent;
	}
  ...
  public NotificationChain basicSetPlaysAgent(Agent newPlaysAgent, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstarPackage.PLAYS__PLAYS_AGENT, oldPlaysAgent, newPlaysAgent);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
  ...
  public void setPlaysAgent(Agent newPlaysAgent)
  {
		if (newPlaysAgent != playsAgent) {
			NotificationChain msgs = null;
			if (playsAgent != null)
				msgs = ((InternalEObject)playsAgent).eInverseRemove(this, IstarPackage.AGENT__AGENT_PLAYS, Agent.class, msgs);
			if (newPlaysAgent != null)
				msgs = ((InternalEObject)newPlaysAgent).eInverseAdd(this, IstarPackage.AGENT__AGENT_PLAYS, Agent.class, msgs);
			msgs = basicSetPlaysAgent(newPlaysAgent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IstarPackage.PLAYS__PLAYS_AGENT, newPlaysAgent, newPlaysAgent));
	}
  ...
  {
		switch (featureID) {
			case IstarPackage.PLAYS__PLAYS_ROLE:
				if (playsRole != null)
					msgs = ((InternalEObject)playsRole).eInverseRemove(this, IstarPackage.ROLE__ROLE_PLAYS, Role.class, msgs);
				return basicSetPlaysRole((Role)otherEnd, msgs);
			case IstarPackage.PLAYS__PLAYS_AGENT:
				if (playsAgent != null)
					msgs = ((InternalEObject)playsAgent).eInverseRemove(this, IstarPackage.AGENT__AGENT_PLAYS, Agent.class, msgs);
