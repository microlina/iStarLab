 ...
 * <ul>
 *   <li>{@link istar.impl.INSImpl#getINSagent <em>IN Sagent</em>}</li>
 *   <li>{@link istar.impl.INSImpl#getINSsecondAgent <em>IN Ssecond Agent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class INSImpl extends AssociationImpl implements INS
{
  ...
  {
		return IstarPackage.Literals.INS;
	}
		...
		if (inSagent != null && inSagent.eIsProxy()) {
			...
			if (inSagent != oldINSagent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstarPackage.INS__IN_SAGENT, oldINSagent, inSagent));
			}
		}
		return inSagent;
	}
  ...
  public NotificationChain basicSetINSagent(Agent newINSagent, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstarPackage.INS__IN_SAGENT, oldINSagent, newINSagent);
  ...
  public void setINSagent(Agent newINSagent)
  {
		if (newINSagent != inSagent) {
			...
			if (inSagent != null)
				msgs = ((InternalEObject)inSagent).eInverseRemove(this, IstarPackage.AGENT__AGENT_INS, Agent.class, msgs);
			if (newINSagent != null)
				msgs = ((InternalEObject)newINSagent).eInverseAdd(this, IstarPackage.AGENT__AGENT_INS, Agent.class, msgs);
			msgs = basicSetINSagent(newINSagent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IstarPackage.INS__IN_SAGENT, newINSagent, newINSagent));
	}
  ...
  public Agent getINSsecondAgent()
  {
		if (inSsecondAgent != null && inSsecondAgent.eIsProxy()) {
			...
			if (inSsecondAgent != oldINSsecondAgent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstarPackage.INS__IN_SSECOND_AGENT, oldINSsecondAgent, inSsecondAgent));
			}
		}
  ...
  public NotificationChain basicSetINSsecondAgent(Agent newINSsecondAgent, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstarPackage.INS__IN_SSECOND_AGENT, oldINSsecondAgent, newINSsecondAgent);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
  ...
  public void setINSsecondAgent(Agent newINSsecondAgent)
  {
		if (newINSsecondAgent != inSsecondAgent) {
			...
			if (inSsecondAgent != null)
				msgs = ((InternalEObject)inSsecondAgent).eInverseRemove(this, IstarPackage.AGENT__SECOND_AGENT_INS, Agent.class, msgs);
			if (newINSsecondAgent != null)
				msgs = ((InternalEObject)newINSsecondAgent).eInverseAdd(this, IstarPackage.AGENT__SECOND_AGENT_INS, Agent.class, msgs);
			msgs = basicSetINSsecondAgent(newINSsecondAgent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IstarPackage.INS__IN_SSECOND_AGENT, newINSsecondAgent, newINSsecondAgent));
	}
  ...
  {
		switch (featureID) {
			case IstarPackage.INS__IN_SAGENT:
				if (inSagent != null)
					msgs = ((InternalEObject)inSagent).eInverseRemove(this, IstarPackage.AGENT__AGENT_INS, Agent.class, msgs);
				return basicSetINSagent((Agent)otherEnd, msgs);
			case IstarPackage.INS__IN_SSECOND_AGENT:
				if (inSsecondAgent != null)
					msgs = ((InternalEObject)inSsecondAgent).eInverseRemove(this, IstarPackage.AGENT__SECOND_AGENT_INS, Agent.class, msgs);
