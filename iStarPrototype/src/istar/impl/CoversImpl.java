 ...
 * <ul>
 *   <li>{@link istar.impl.CoversImpl#getCoversRole <em>Covers Role</em>}</li>
 *   <li>{@link istar.impl.CoversImpl#getCoversPosition <em>Covers Position</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CoversImpl extends AssociationImpl implements Covers
{
  ...
  {
		return IstarPackage.Literals.COVERS;
	}
		...
		if (coversRole != null && coversRole.eIsProxy()) {
			...
			if (coversRole != oldCoversRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstarPackage.COVERS__COVERS_ROLE, oldCoversRole, coversRole));
			}
		}
		return coversRole;
	}
  ...
  public NotificationChain basicSetCoversRole(Role newCoversRole, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstarPackage.COVERS__COVERS_ROLE, oldCoversRole, newCoversRole);
  ...
  public void setCoversRole(Role newCoversRole)
  {
		if (newCoversRole != coversRole) {
			...
			if (coversRole != null)
				msgs = ((InternalEObject)coversRole).eInverseRemove(this, IstarPackage.ROLE__ROLE_COVERS, Role.class, msgs);
			if (newCoversRole != null)
				msgs = ((InternalEObject)newCoversRole).eInverseAdd(this, IstarPackage.ROLE__ROLE_COVERS, Role.class, msgs);
			msgs = basicSetCoversRole(newCoversRole, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IstarPackage.COVERS__COVERS_ROLE, newCoversRole, newCoversRole));
	}
  ...
  public Position getCoversPosition()
  {
		if (coversPosition != null && coversPosition.eIsProxy()) {
			...
			if (coversPosition != oldCoversPosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstarPackage.COVERS__COVERS_POSITION, oldCoversPosition, coversPosition));
			}
		}
  ...
  public NotificationChain basicSetCoversPosition(Position newCoversPosition, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstarPackage.COVERS__COVERS_POSITION, oldCoversPosition, newCoversPosition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
  ...
  public void setCoversPosition(Position newCoversPosition)
  {
		if (newCoversPosition != coversPosition) {
			...
			if (coversPosition != null)
				msgs = ((InternalEObject)coversPosition).eInverseRemove(this, IstarPackage.POSITION__POSITION_COVERS, Position.class, msgs);
			if (newCoversPosition != null)
				msgs = ((InternalEObject)newCoversPosition).eInverseAdd(this, IstarPackage.POSITION__POSITION_COVERS, Position.class, msgs);
			msgs = basicSetCoversPosition(newCoversPosition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IstarPackage.COVERS__COVERS_POSITION, newCoversPosition, newCoversPosition));
	}
  ...
  {
		switch (featureID) {
			case IstarPackage.COVERS__COVERS_ROLE:
				if (coversRole != null)
					msgs = ((InternalEObject)coversRole).eInverseRemove(this, IstarPackage.ROLE__ROLE_COVERS, Role.class, msgs);
				return basicSetCoversRole((Role)otherEnd, msgs);
			case IstarPackage.COVERS__COVERS_POSITION:
				if (coversPosition != null)
					msgs = ((InternalEObject)coversPosition).eInverseRemove(this, IstarPackage.POSITION__POSITION_COVERS, Position.class, msgs);
