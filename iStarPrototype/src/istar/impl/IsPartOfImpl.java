 ...
 * <ul>
 *   <li>{@link istar.impl.IsPartOfImpl#getIsPartOfActor <em>Is Part Of Actor</em>}</li>
 *   <li>{@link istar.impl.IsPartOfImpl#getIsPartOfSecondActor <em>Is Part Of Second Actor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IsPartOfImpl extends AssociationImpl implements IsPartOf
{
  ...
  {
		return IstarPackage.Literals.IS_PART_OF;
	}
		...
		if (isPartOfActor != null && isPartOfActor.eIsProxy()) {
			...
			if (isPartOfActor != oldIsPartOfActor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstarPackage.IS_PART_OF__IS_PART_OF_ACTOR, oldIsPartOfActor, isPartOfActor));
			}
		}
  ...
  public NotificationChain basicSetIsPartOfActor(Actor newIsPartOfActor, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstarPackage.IS_PART_OF__IS_PART_OF_ACTOR, oldIsPartOfActor, newIsPartOfActor);
  ...
  public void setIsPartOfActor(Actor newIsPartOfActor)
  {
		if (newIsPartOfActor != isPartOfActor) {
			...
			if (isPartOfActor != null)
				msgs = ((InternalEObject)isPartOfActor).eInverseRemove(this, IstarPackage.ACTOR__ACTOR_IS_PART_OF, Actor.class, msgs);
			if (newIsPartOfActor != null)
				msgs = ((InternalEObject)newIsPartOfActor).eInverseAdd(this, IstarPackage.ACTOR__ACTOR_IS_PART_OF, Actor.class, msgs);
			msgs = basicSetIsPartOfActor(newIsPartOfActor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IstarPackage.IS_PART_OF__IS_PART_OF_ACTOR, newIsPartOfActor, newIsPartOfActor));
	}
  ...
  public Actor getIsPartOfSecondActor()
  {
		if (isPartOfSecondActor != null && isPartOfSecondActor.eIsProxy()) {
			...
			if (isPartOfSecondActor != oldIsPartOfSecondActor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstarPackage.IS_PART_OF__IS_PART_OF_SECOND_ACTOR, oldIsPartOfSecondActor, isPartOfSecondActor));
			}
		}
  ...
  public NotificationChain basicSetIsPartOfSecondActor(Actor newIsPartOfSecondActor, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstarPackage.IS_PART_OF__IS_PART_OF_SECOND_ACTOR, oldIsPartOfSecondActor, newIsPartOfSecondActor);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
  ...
  public void setIsPartOfSecondActor(Actor newIsPartOfSecondActor)
  {
		if (newIsPartOfSecondActor != isPartOfSecondActor) {
			...
			if (isPartOfSecondActor != null)
				msgs = ((InternalEObject)isPartOfSecondActor).eInverseRemove(this, IstarPackage.ACTOR__SECOND_ACTOR_IS_PART_OF, Actor.class, msgs);
			if (newIsPartOfSecondActor != null)
				msgs = ((InternalEObject)newIsPartOfSecondActor).eInverseAdd(this, IstarPackage.ACTOR__SECOND_ACTOR_IS_PART_OF, Actor.class, msgs);
			msgs = basicSetIsPartOfSecondActor(newIsPartOfSecondActor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IstarPackage.IS_PART_OF__IS_PART_OF_SECOND_ACTOR, newIsPartOfSecondActor, newIsPartOfSecondActor));
	}
  ...
  {
		switch (featureID) {
			case IstarPackage.IS_PART_OF__IS_PART_OF_ACTOR:
				if (isPartOfActor != null)
					msgs = ((InternalEObject)isPartOfActor).eInverseRemove(this, IstarPackage.ACTOR__ACTOR_IS_PART_OF, Actor.class, msgs);
				return basicSetIsPartOfActor((Actor)otherEnd, msgs);
			case IstarPackage.IS_PART_OF__IS_PART_OF_SECOND_ACTOR:
				if (isPartOfSecondActor != null)
					msgs = ((InternalEObject)isPartOfSecondActor).eInverseRemove(this, IstarPackage.ACTOR__SECOND_ACTOR_IS_PART_OF, Actor.class, msgs);
