 ...
 * <ul>
 *   <li>{@link istar.impl.ISAImpl#getISAactor <em>IS Aactor</em>}</li>
 *   <li>{@link istar.impl.ISAImpl#getISAsecondActor <em>IS Asecond Actor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ISAImpl extends AssociationImpl implements ISA
{
  ...
  {
		return IstarPackage.Literals.ISA;
	}
		...
		if (isAactor != null && isAactor.eIsProxy()) {
			...
			if (isAactor != oldISAactor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstarPackage.ISA__IS_AACTOR, oldISAactor, isAactor));
			}
		}
		return isAactor;
	}
  ...
  public NotificationChain basicSetISAactor(Actor newISAactor, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstarPackage.ISA__IS_AACTOR, oldISAactor, newISAactor);
  ...
  public void setISAactor(Actor newISAactor)
  {
		if (newISAactor != isAactor) {
			...
			if (isAactor != null)
				msgs = ((InternalEObject)isAactor).eInverseRemove(this, IstarPackage.ACTOR__ACTOR_ISA, Actor.class, msgs);
			if (newISAactor != null)
				msgs = ((InternalEObject)newISAactor).eInverseAdd(this, IstarPackage.ACTOR__ACTOR_ISA, Actor.class, msgs);
			msgs = basicSetISAactor(newISAactor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IstarPackage.ISA__IS_AACTOR, newISAactor, newISAactor));
	}
  ...
  public Actor getISAsecondActor()
  {
		if (isAsecondActor != null && isAsecondActor.eIsProxy()) {
			...
			if (isAsecondActor != oldISAsecondActor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IstarPackage.ISA__IS_ASECOND_ACTOR, oldISAsecondActor, isAsecondActor));
			}
		}
  ...
  public NotificationChain basicSetISAsecondActor(Actor newISAsecondActor, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IstarPackage.ISA__IS_ASECOND_ACTOR, oldISAsecondActor, newISAsecondActor);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
  ...
  public void setISAsecondActor(Actor newISAsecondActor)
  {
		if (newISAsecondActor != isAsecondActor) {
			...
			if (isAsecondActor != null)
				msgs = ((InternalEObject)isAsecondActor).eInverseRemove(this, IstarPackage.ACTOR__SECOND_ACTOR_ISA, Actor.class, msgs);
			if (newISAsecondActor != null)
				msgs = ((InternalEObject)newISAsecondActor).eInverseAdd(this, IstarPackage.ACTOR__SECOND_ACTOR_ISA, Actor.class, msgs);
			msgs = basicSetISAsecondActor(newISAsecondActor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IstarPackage.ISA__IS_ASECOND_ACTOR, newISAsecondActor, newISAsecondActor));
	}
  ...
  {
		switch (featureID) {
			case IstarPackage.ISA__IS_AACTOR:
				if (isAactor != null)
					msgs = ((InternalEObject)isAactor).eInverseRemove(this, IstarPackage.ACTOR__ACTOR_ISA, Actor.class, msgs);
				return basicSetISAactor((Actor)otherEnd, msgs);
			case IstarPackage.ISA__IS_ASECOND_ACTOR:
				if (isAsecondActor != null)
					msgs = ((InternalEObject)isAsecondActor).eInverseRemove(this, IstarPackage.ACTOR__SECOND_ACTOR_ISA, Actor.class, msgs);
