...
public class IstarSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
		switch (classifierID) {
			...
			case IstarPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IstarPackage.RELATIONSHIP: {
				Relationship relationship = (Relationship)theEObject;
				T result = caseRelationship(relationship);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IstarPackage.ACTORS: {
			...
			case IstarPackage.CONTRIBUTION_LINK: {
			...
			case IstarPackage.DECOMPOSITION_LINK: {
			...
			case IstarPackage.DEPENDENCY_LINK: {
