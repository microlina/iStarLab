 ...
 * @generated
 */
public abstract class IstarAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = IstarDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected IstarAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
