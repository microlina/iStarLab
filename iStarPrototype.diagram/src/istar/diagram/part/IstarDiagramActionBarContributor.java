...
import istar.diagram.providers.IstarMetricProvider;
 ...
 * @generated
 */
public class IstarDiagramActionBarContributor extends
	...
	protected Class getEditorClass() {
		return IstarDiagramEditor.class;
	}
	...
	public void init(IActionBars bars, IWorkbenchPage page) {
		...
		IAction metricsAction = new IstarMetricProvider.MetricsAction(page);
