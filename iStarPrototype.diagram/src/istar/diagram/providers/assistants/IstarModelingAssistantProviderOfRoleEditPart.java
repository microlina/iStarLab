 ...
 * @generated
 */
public class IstarModelingAssistantProviderOfRoleEditPart extends
	...
	public List<IElementType> doGetTypesForTarget(RoleEditPart source,
		...
		if (relationshipType == IstarElementTypes.DependencyLink_4036) {
	...
	public List<IElementType> doGetTypesForSource(RoleEditPart target,
		...
		if (relationshipType == IstarElementTypes.Plays_4021) {
			types.add(IstarElementTypes.Agent_2012);
		} else if (relationshipType == IstarElementTypes.Covers_4022) {
			types.add(IstarElementTypes.Position_2013);
