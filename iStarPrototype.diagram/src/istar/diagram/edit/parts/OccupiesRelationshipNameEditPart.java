 ...
 * @generated
 */
public class OccupiesRelationshipNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				IstarVisualIDRegistry
						.getType(istar.diagram.edit.parts.OccupiesRelationshipNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public OccupiesRelationshipNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new OccupiesLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OccupiesLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OccupiesLabelFigure() {
			this.setText("Occupies");
		}
