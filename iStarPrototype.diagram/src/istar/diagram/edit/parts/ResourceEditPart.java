...
import istar.diagram.edit.policies.ResourceItemSemanticEditPolicy;
...
public class ResourceEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ResourceNodeNameEditPart) {
			((ResourceNodeNameEditPart) childEditPart)
