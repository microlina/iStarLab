 ...
 * @generated
 */
public class CoversRelationshipNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				IstarVisualIDRegistry
						.getType(istar.diagram.edit.parts.CoversRelationshipNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public CoversRelationshipNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new CoversLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CoversLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CoversLabelFigure() {
			this.setText("Covers");
		}
