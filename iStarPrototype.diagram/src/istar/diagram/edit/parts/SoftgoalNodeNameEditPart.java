 ...
 * @generated
 */
public class SoftgoalNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SoftgoalNodeNameEditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.SoftgoalNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
