 ...
 * @generated
 */
public class INSRelationshipNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				IstarVisualIDRegistry
						.getType(istar.diagram.edit.parts.INSRelationshipNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public INSRelationshipNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new INSLabelFigure();
	}

	/**
	 * @generated
	 */
	public class INSLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public INSLabelFigure() {
			this.setText("INS");
		}
