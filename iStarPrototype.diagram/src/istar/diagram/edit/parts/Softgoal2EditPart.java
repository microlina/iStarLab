...
import istar.diagram.edit.policies.Softgoal2ItemSemanticEditPolicy;
...
public class Softgoal2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Softgoal2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SoftgoalNodeName2EditPart) {
			((SoftgoalNodeName2EditPart) childEditPart)
	 ...
	 * @generated
	 */
	public class SoftgoalFigure extends ScalablePolygonShape {
		...
		private void createContents() {
			...
			GridData constraintFFigureSoftgoalLabelFigure = new GridData();
			constraintFFigureSoftgoalLabelFigure.verticalAlignment = GridData.CENTER;
			constraintFFigureSoftgoalLabelFigure.horizontalAlignment = GridData.CENTER;
			constraintFFigureSoftgoalLabelFigure.horizontalIndent = 0;
			constraintFFigureSoftgoalLabelFigure.horizontalSpan = 1;
			constraintFFigureSoftgoalLabelFigure.verticalSpan = 1;
			constraintFFigureSoftgoalLabelFigure.grabExcessHorizontalSpace = true;
			constraintFFigureSoftgoalLabelFigure.grabExcessVerticalSpace = true;
			this.add(fFigureSoftgoalLabelFigure,
					constraintFFigureSoftgoalLabelFigure);
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 206, 255, 153);
