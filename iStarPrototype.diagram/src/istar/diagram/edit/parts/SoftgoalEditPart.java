...
import istar.diagram.edit.policies.SoftgoalItemSemanticEditPolicy;
...
public class SoftgoalEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SoftgoalItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SoftgoalNodeNameEditPart) {
			((SoftgoalNodeNameEditPart) childEditPart)
