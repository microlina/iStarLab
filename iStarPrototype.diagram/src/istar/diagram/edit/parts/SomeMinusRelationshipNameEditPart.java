 ...
 * @generated
 */
public class SomeMinusRelationshipNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				IstarVisualIDRegistry
						.getType(istar.diagram.edit.parts.SomeMinusRelationshipNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public SomeMinusRelationshipNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new SomeMinusLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SomeMinusLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SomeMinusLabelFigure() {
			this.setText("Some-");
		}
