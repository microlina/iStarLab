 ...
 * @generated
 */
public class BeliefNodeName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BeliefNodeName2EditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.BeliefNodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
