 ...
 * @generated
 */
public class SoftgoalNodeName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SoftgoalNodeName2EditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.SoftgoalNodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
