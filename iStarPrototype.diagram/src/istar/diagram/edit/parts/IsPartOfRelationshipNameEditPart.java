 ...
 * @generated
 */
public class IsPartOfRelationshipNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				IstarVisualIDRegistry
						.getType(istar.diagram.edit.parts.IsPartOfRelationshipNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public IsPartOfRelationshipNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new IsPartOfLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IsPartOfLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IsPartOfLabelFigure() {
			this.setText("IsPartOf");
		}
