 ...
 * @generated
 */
public class TaskNodeName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TaskNodeName2EditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.TaskNodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
