 ...
 * @generated
 */
public class ResourceNodeName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ResourceNodeName2EditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.ResourceNodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
