 ...
 * @generated
 */
public class UnknownRelationshipNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				IstarVisualIDRegistry
						.getType(istar.diagram.edit.parts.UnknownRelationshipNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public UnknownRelationshipNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new UnknownLabelFigure();
	}

	/**
	 * @generated
	 */
	public class UnknownLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public UnknownLabelFigure() {
