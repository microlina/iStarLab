 ...
 * @generated
 */
public class AndRelationshipNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				IstarVisualIDRegistry
						.getType(istar.diagram.edit.parts.AndRelationshipNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public AndRelationshipNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new AndLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AndLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AndLabelFigure() {
			this.setText("And");
		}
