 ...
 * @generated
 */
public class SomePlusRelationshipNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				IstarVisualIDRegistry
						.getType(istar.diagram.edit.parts.SomePlusRelationshipNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public SomePlusRelationshipNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new SomePlusLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SomePlusLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SomePlusLabelFigure() {
			this.setText("Some+");
		}
