 ...
 * @generated
 */
public class AgentNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AgentNodeNameEditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.AgentNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
