 ...
 * @generated
 */
public class RoleNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RoleNodeNameEditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.RoleNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
