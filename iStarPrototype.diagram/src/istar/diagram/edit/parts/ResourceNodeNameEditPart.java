 ...
 * @generated
 */
public class ResourceNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ResourceNodeNameEditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.ResourceNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
