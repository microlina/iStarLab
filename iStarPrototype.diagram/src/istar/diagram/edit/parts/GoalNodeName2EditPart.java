 ...
 * @generated
 */
public class GoalNodeName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GoalNodeName2EditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.GoalNodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
