...
import istar.diagram.edit.commands.IstarCreateShortcutDecorationsCommand;
import istar.diagram.edit.policies.ISTARCanonicalEditPolicy;
import istar.diagram.edit.policies.ISTARItemSemanticEditPolicy;
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new IstarCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
