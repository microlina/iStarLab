 ...
 * @generated
 */
public class BeliefNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BeliefNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = IstarParserProvider
					.getParser(
							IstarElementTypes.Belief_2019,
							getParserElement(),
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.BeliefNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
