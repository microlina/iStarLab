...
import istar.diagram.edit.policies.IstarTextSelectionEditPolicy;
 ...
 * @generated
 */
public class DependencyLinkDependencyNameEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				IstarVisualIDRegistry
						.getType(istar.diagram.edit.parts.DependencyLinkDependencyNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public DependencyLinkDependencyNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new IstarTextSelectionEditPolicy());
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					IstarEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new DependencyLinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DependencyLinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DependencyLinkLabelFigure() {
			this.setText("DependencyLink");
		}
