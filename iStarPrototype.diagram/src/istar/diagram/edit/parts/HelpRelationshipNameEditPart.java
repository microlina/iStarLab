 ...
 * @generated
 */
public class HelpRelationshipNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				IstarVisualIDRegistry
						.getType(istar.diagram.edit.parts.HelpRelationshipNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public HelpRelationshipNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new HelpLabelFigure();
	}

	/**
	 * @generated
	 */
	public class HelpLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public HelpLabelFigure() {
			this.setText("Help");
		}
