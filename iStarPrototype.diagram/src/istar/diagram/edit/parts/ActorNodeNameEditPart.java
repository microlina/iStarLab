 ...
 * @generated
 */
public class ActorNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActorNodeNameEditPart(View view) {
		super(view);
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.ActorNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
