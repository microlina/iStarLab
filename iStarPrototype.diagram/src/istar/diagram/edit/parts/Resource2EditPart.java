...
import istar.diagram.edit.policies.Resource2ItemSemanticEditPolicy;
...
public class Resource2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Resource2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ResourceNodeName2EditPart) {
			((ResourceNodeName2EditPart) childEditPart)
	...
	public class ResourceFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			GridData constraintFFigureResourceLabelFigure = new GridData();
			constraintFFigureResourceLabelFigure.verticalAlignment = GridData.CENTER;
			constraintFFigureResourceLabelFigure.horizontalAlignment = GridData.CENTER;
			constraintFFigureResourceLabelFigure.horizontalIndent = 0;
			constraintFFigureResourceLabelFigure.horizontalSpan = 1;
			constraintFFigureResourceLabelFigure.verticalSpan = 1;
			constraintFFigureResourceLabelFigure.grabExcessHorizontalSpace = true;
			constraintFFigureResourceLabelFigure.grabExcessVerticalSpace = true;
			this.add(fFigureResourceLabelFigure,
					constraintFFigureResourceLabelFigure);
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 255, 255, 179);
