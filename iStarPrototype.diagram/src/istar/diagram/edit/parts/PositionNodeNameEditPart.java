 ...
 * @generated
 */
public class PositionNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PositionNodeNameEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return IstarElementTypes.getImage(parserElement.eClass());
	}
			...
			parser = IstarParserProvider
					.getParser(
							...
							IstarVisualIDRegistry
									.getType(istar.diagram.edit.parts.PositionNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
