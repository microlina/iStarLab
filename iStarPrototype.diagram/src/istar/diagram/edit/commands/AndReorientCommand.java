 ...
 * @generated
 */
public class AndReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AndReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof And) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAnd_4031(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		istar.ISTAR container = (istar.ISTAR) getLink().eContainer();
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAnd_4031(container, getLink(), source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected And getLink() {
		return (And) getElementToEdit();
	}
