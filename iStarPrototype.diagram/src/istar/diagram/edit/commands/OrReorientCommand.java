 ...
 * @generated
 */
public class OrReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OrReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Or) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOr_4032(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		istar.ISTAR container = (istar.ISTAR) getLink().eContainer();
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOr_4032(container, getLink(), source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Or getLink() {
		return (Or) getElementToEdit();
	}
