 ...
 * @generated
 */
public class BreakReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BreakReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Break) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistBreak_4026(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		istar.ISTAR container = (istar.ISTAR) getLink().eContainer();
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistBreak_4026(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Break getLink() {
		return (Break) getElementToEdit();
	}
