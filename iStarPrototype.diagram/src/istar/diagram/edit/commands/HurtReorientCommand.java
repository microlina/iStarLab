 ...
 * @generated
 */
public class HurtReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HurtReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Hurt) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return IstarBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistHurt_4028(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return IstarBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistHurt_4028(container, getLink(), source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Hurt getLink() {
		return (Hurt) getElementToEdit();
	}
