 ...
 * @generated
 */
public class SomeMinusReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SomeMinusReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof SomeMinus) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSomeMinus_4030(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		istar.ISTAR container = (istar.ISTAR) getLink().eContainer();
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSomeMinus_4030(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected SomeMinus getLink() {
		return (SomeMinus) getElementToEdit();
	}
