 ...
 * @generated
 */
public class UnknownReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public UnknownReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Unknown) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistUnknown_4033(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		istar.ISTAR container = (istar.ISTAR) getLink().eContainer();
		return IstarBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistUnknown_4033(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Unknown getLink() {
		return (Unknown) getElementToEdit();
	}
