...
public class PositionItemSemanticEditPolicy extends
	 ...
	 * @generated
	 */
	public PositionItemSemanticEditPolicy() {
		super(IstarElementTypes.Position_2013);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (IstarVisualIDRegistry.getVisualID(incomingLink) == OccupiesEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (IstarVisualIDRegistry.getVisualID(outgoingLink) == CoversEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
