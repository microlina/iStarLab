 ...
 * @generated
 */
public class AgentAgentHasElementCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getAgentAgentHasElementCompartment_7006SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getAgentAgentHasElementCompartment_7006SemanticChildren((View) getHost()
						.getModel());
