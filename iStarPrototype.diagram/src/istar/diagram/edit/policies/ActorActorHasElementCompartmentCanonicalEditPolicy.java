 ...
 * @generated
 */
public class ActorActorHasElementCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getActorActorHasElementCompartment_7005SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getActorActorHasElementCompartment_7005SemanticChildren((View) getHost()
						.getModel());
