...
import istar.diagram.edit.commands.INSCreateCommand;
import istar.diagram.edit.commands.INSReorientCommand;
import istar.diagram.edit.commands.OccupiesCreateCommand;
import istar.diagram.edit.commands.OccupiesReorientCommand;
import istar.diagram.edit.commands.PlaysCreateCommand;
import istar.diagram.edit.commands.PlaysReorientCommand;
...
public class AgentItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (IstarVisualIDRegistry.getVisualID(incomingLink) == INSEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (IstarVisualIDRegistry.getVisualID(outgoingLink) == PlaysEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
			...
			if (IstarVisualIDRegistry.getVisualID(outgoingLink) == OccupiesEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
			...
			if (IstarVisualIDRegistry.getVisualID(outgoingLink) == INSEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit
					...
					case Softgoal2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it
								.hasNext();) {
							Edge incomingLink = (Edge) it.next();
							if (IstarVisualIDRegistry.getVisualID(incomingLink) == MakeEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (IstarVisualIDRegistry.getVisualID(incomingLink) == BreakEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (IstarVisualIDRegistry.getVisualID(incomingLink) == HelpEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (IstarVisualIDRegistry.getVisualID(incomingLink) == HurtEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (IstarVisualIDRegistry.getVisualID(incomingLink) == SomePlusEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (IstarVisualIDRegistry.getVisualID(incomingLink) == SomeMinusEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (IstarVisualIDRegistry.getVisualID(incomingLink) == AndEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (IstarVisualIDRegistry.getVisualID(incomingLink) == OrEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (IstarVisualIDRegistry.getVisualID(incomingLink) == UnknownEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
					...
					case Task2EditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (IstarVisualIDRegistry.getVisualID(outgoingLink) == DecompositionLinkEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (IstarElementTypes.Plays_4021 == req.getElementType()) {
			return getGEFWrapper(new PlaysCreateCommand(req, req.getSource(),
					req.getTarget()));
		}
		if (IstarElementTypes.Occupies_4023 == req.getElementType()) {
			return getGEFWrapper(new OccupiesCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (IstarElementTypes.INS_4024 == req.getElementType()) {
			return getGEFWrapper(new INSCreateCommand(req, req.getSource(),
					req.getTarget()));
		}
	...
	protected Command getReorientRelationshipCommand(
		...
		case PlaysEditPart.VISUAL_ID:
			return getGEFWrapper(new PlaysReorientCommand(req));
		case OccupiesEditPart.VISUAL_ID:
			return getGEFWrapper(new OccupiesReorientCommand(req));
		case INSEditPart.VISUAL_ID:
			return getGEFWrapper(new INSReorientCommand(req));
