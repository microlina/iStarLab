 ...
 * @generated
 */
public class RoleRoleHasElementCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getRoleRoleHasElementCompartment_7008SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getRoleRoleHasElementCompartment_7008SemanticChildren((View) getHost()
						.getModel());
