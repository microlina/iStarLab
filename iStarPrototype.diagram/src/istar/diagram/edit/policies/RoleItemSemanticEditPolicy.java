...
import istar.diagram.edit.commands.CoversCreateCommand;
import istar.diagram.edit.commands.CoversReorientCommand;
 ...
 * @generated
 */
public class RoleItemSemanticEditPolicy extends IstarBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public RoleItemSemanticEditPolicy() {
		super(IstarElementTypes.Role_2014);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (IstarVisualIDRegistry.getVisualID(incomingLink) == PlaysEditPart.VISUAL_ID) {
			...
			if (IstarVisualIDRegistry.getVisualID(incomingLink) == CoversEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (IstarElementTypes.Covers_4022 == req.getElementType()) {
			return null;
		}
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (IstarElementTypes.Covers_4022 == req.getElementType()) {
			return getGEFWrapper(new CoversCreateCommand(req, req.getSource(),
					req.getTarget()));
		}
		if (IstarElementTypes.DependencyLink_4036 == req.getElementType()) {
			return getGEFWrapper(new DependencyLinkCreateCommand(req,
	...
	protected Command getReorientRelationshipCommand(
		...
		case CoversEditPart.VISUAL_ID:
			return getGEFWrapper(new CoversReorientCommand(req));
