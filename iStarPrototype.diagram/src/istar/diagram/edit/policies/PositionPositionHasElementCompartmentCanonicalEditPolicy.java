 ...
 * @generated
 */
public class PositionPositionHasElementCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return IstarPackage.eINSTANCE.getActors_HasElement();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getPositionPositionHasElementCompartment_7007SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<IstarNodeDescriptor> childDescriptors = IstarDiagramUpdater
				.getPositionPositionHasElementCompartment_7007SemanticChildren((View) getHost()
						.getModel());
