...
import istar.diagram.edit.commands.ISACreateCommand;
import istar.diagram.edit.commands.ISAReorientCommand;
import istar.diagram.edit.commands.IsPartOfCreateCommand;
import istar.diagram.edit.commands.IsPartOfReorientCommand;
...
public class ActorItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (IstarVisualIDRegistry.getVisualID(incomingLink) == ISAEditPart.VISUAL_ID) {
			...
			if (IstarVisualIDRegistry.getVisualID(incomingLink) == IsPartOfEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (IstarVisualIDRegistry.getVisualID(outgoingLink) == ISAEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
			...
			if (IstarVisualIDRegistry.getVisualID(outgoingLink) == IsPartOfEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (IstarElementTypes.ISA_4019 == req.getElementType()) {
			return getGEFWrapper(new ISACreateCommand(req, req.getSource(),
					req.getTarget()));
		}
		if (IstarElementTypes.IsPartOf_4020 == req.getElementType()) {
			return getGEFWrapper(new IsPartOfCreateCommand(req,
	...
	protected Command getReorientRelationshipCommand(
		...
		case ISAEditPart.VISUAL_ID:
			return getGEFWrapper(new ISAReorientCommand(req));
		case IsPartOfEditPart.VISUAL_ID:
			return getGEFWrapper(new IsPartOfReorientCommand(req));
