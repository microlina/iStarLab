	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ISTAREditPart.VISUAL_ID: {
			...
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(AgentEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(PositionEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(RoleEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
			...
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(BeliefEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(ISAEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(IsPartOfEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(PlaysEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(CoversEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(OccupiesEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(INSEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(MakeEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(BreakEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(HelpEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(HurtEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(SomePlusEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(SomeMinusEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(AndEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(OrEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(UnknownEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
		...
		case ActorEditPart.VISUAL_ID: {
			...
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Actor_2011_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Actor_2011_outgoinglinks,
			...
			connectedViews = getChildrenByType(
					...
					IstarVisualIDRegistry
							.getType(ActorActorHasElementCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					IstarVisualIDRegistry.getType(Belief2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case AgentEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Agent_2012_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Agent_2012_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case PositionEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Position_2013_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Position_2013_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case RoleEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Role_2014_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Role_2014_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case GoalEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Goal_2015_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Goal_2015_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(MakeEditPart.VISUAL_ID));
		...
		case SoftgoalEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2016_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2016_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(MakeEditPart.VISUAL_ID));
		...
		case TaskEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Task_2017_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Task_2017_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(MakeEditPart.VISUAL_ID));
		...
		case ResourceEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Resource_2018_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Resource_2018_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(MakeEditPart.VISUAL_ID));
		...
		case BeliefEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Belief_2019_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Belief_2019_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(MakeEditPart.VISUAL_ID));
		...
		case Goal2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Goal_3006_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Goal_3006_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(MakeEditPart.VISUAL_ID));
		...
		case Softgoal2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_3007_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_3007_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(MakeEditPart.VISUAL_ID));
		...
		case Resource2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Resource_3009_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Resource_3009_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(MakeEditPart.VISUAL_ID));
		...
		case Belief2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			IstarNavigatorGroup outgoinglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Belief_3010_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup incominglinks = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Belief_3010_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(MakeEditPart.VISUAL_ID));
		...
		case ISAEditPart.VISUAL_ID: {
			...
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_ISA_4019_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_ISA_4019_source,
		...
		case IsPartOfEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_IsPartOf_4020_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_IsPartOf_4020_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(ActorEditPart.VISUAL_ID));
		...
		case PlaysEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Plays_4021_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Plays_4021_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(RoleEditPart.VISUAL_ID));
		...
		case CoversEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Covers_4022_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Covers_4022_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(RoleEditPart.VISUAL_ID));
		...
		case OccupiesEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Occupies_4023_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Occupies_4023_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(PositionEditPart.VISUAL_ID));
		...
		case INSEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_INS_4024_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_INS_4024_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(AgentEditPart.VISUAL_ID));
		...
		case MakeEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Make_4025_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Make_4025_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(SoftgoalEditPart.VISUAL_ID));
		...
		case BreakEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Break_4026_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Break_4026_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(SoftgoalEditPart.VISUAL_ID));
		...
		case HelpEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Help_4027_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Help_4027_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(SoftgoalEditPart.VISUAL_ID));
		...
		case HurtEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Hurt_4028_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Hurt_4028_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(SoftgoalEditPart.VISUAL_ID));
		...
		case SomePlusEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_SomePlus_4029_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_SomePlus_4029_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(SoftgoalEditPart.VISUAL_ID));
		...
		case SomeMinusEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_SomeMinus_4030_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_SomeMinus_4030_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(SoftgoalEditPart.VISUAL_ID));
		...
		case AndEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_And_4031_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_And_4031_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(SoftgoalEditPart.VISUAL_ID));
		...
		case OrEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Or_4032_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Or_4032_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(SoftgoalEditPart.VISUAL_ID));
		...
		case UnknownEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Unknown_4033_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_Unknown_4033_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(SoftgoalEditPart.VISUAL_ID));
		...
		case MeansEndEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_MeansEnd_4034_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_MeansEnd_4034_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(GoalEditPart.VISUAL_ID));
		...
		case DecompositionLinkEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_DecompositionLink_4035_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_DecompositionLink_4035_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(GoalEditPart.VISUAL_ID));
		...
		case DependencyLinkEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			IstarNavigatorGroup target = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_DependencyLink_4036_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			IstarNavigatorGroup source = new IstarNavigatorGroup(
					Messages.NavigatorGroupName_DependencyLink_4036_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					IstarVisualIDRegistry.getType(ActorEditPart.VISUAL_ID));
